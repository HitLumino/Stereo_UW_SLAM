...
void Viewer::Run()
{
    ...
    pangolin::CreateWindowAndBind("STEREO-UW-SLAM: Map Viewer",1024,768);
    ...
    pangolin::Var<bool> menuShowLineProject("menu.Show Line Project",false,true);
    ...
    cv::namedWindow("STEREO-UW-SLAM: Current Frame");
    ...
    while(1)
    {
        ...
        ///2018.4.4
        if(menuShowLineProject)//menuShowLineProject
        {
        ...
        cv::imshow("STEREO-UW-SLAM: Current Frame",im);
        cv::waitKey(mT);
